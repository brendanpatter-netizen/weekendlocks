...
const styles = StyleSheet.create({
  ...
  // Gold text is the only "leader" signal now — color doing the work an
  // icon used to, same restraint as the streak badges' ink-only treatment.
  leaderName: { fontSize: 13, fontWeight: "700", color: theme.brass, flexShrink: 1 },
